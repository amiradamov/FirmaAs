...
class AboutPageState extends State<AboutPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget productList(String MyImages, String Title, String Price, String Ost) {
      double _volume = 0.0;
  return Padding(
    ...
    child: Card(
      child: InkWell(
        onTap: () {
          Navigator.of(context).push(MaterialPageRoute(builder:(context)=>ProductPage(Title, MyImages, Price, Ost)));
        },
                        ...
                        return Container(
                          child: Column(
                            children: [
                              ...
                              if(cat_name == items[index].GROUP_NAME.toString())
                                productList(items[index].N_PROD.toString(),
                          items[index].TOV_NAME.toString(), items[index].PRICE.toString(), items[index].OST.toString()),
                            ],
                            ),
                        );
                      },
